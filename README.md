...
*После того, как турист с помощью мобильного приложения отправит в БД информацию о новом перевале, сотрудники ФСТР проведут модерацию для каждого нового объекта и поменяют поле status.*
...
GET /User/<id>
```
*получает одну запись (пользователь) по её id с выведением всей информацию о пользователе.*
...
*позволяет получить данные всех пользователей с указанной фамилией.* 

В качестве реализации использована фильтрация по фамилии пользователя с помощью пакета **django-filter**
...
*API **submitData**: https://alexjay37555.pythonanywhere.com/*<br/>
*Документация **swagger**: https://alexjay37555.pythonanywhere.com/swagger/<br/>*
*Документация **redoc**: https://alexjay37555.pythonanywhere.com/redoc/*
